...
public final class Constants {
    ...
    // Physics & Grid
    public static final int TILE_SIZE = 40;          // 40px grid matches 20px draw.io units (Scale 2.0)
    public static final double GRAVITY = 1200.0;     // Pixels per second squared
    public static final double MAX_FALL_SPEED = 900.0;

    // Player Properties
    // Tuned for: jump height 2 blocks (~85px), jump distance 6 blocks (~240px+)
    public static final int PLAYER_MAX_HP = 100;
    public static final double PLAYER_MOVE_SPEED = 280.0;
    public static final double PLAYER_JUMP_SPEED = -500.0;
    public static final int PLAYER_WIDTH = 36;
    public static final int PLAYER_HEIGHT = 56;
    public static final int PLAYER_CROUCH_HEIGHT = 24;
    ...
    public static final double PLAYER_BULLET_SPEED = 800.0;
